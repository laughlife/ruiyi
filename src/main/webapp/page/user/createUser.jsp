                ...
                <div class="layui-card-body">
                    <form class="layui-form layui-form-pane">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-form-mid layui-text-em">6 到 12
                                位字符，密码一经设置，可以修改不能找回(数据库加密无法逆向解密)
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <button type="button" lay-submit class="layui-btn layui-bg-blue"
                                    lay-filter="add-user-filter">确认添加
                            </button>
...
<script>
    layui.use(function () {
        ...
        form.on('submit(add-user-filter)', function (data) {
            var _data = data.field;
            _data.password = md5WithCryptoJS(_data.password);
            $.ajax({
                url: '/user/addUser',
                type: 'post',
                data: _data,
