...
public class TOrderItemMapper implements RowMapper<TOrderItem> {
    ...
    public TOrderItem mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        obj.setOrderItemId(rs.getInt("order_item_id"));
        ...
        obj.setConditionId(rs.getInt("condition_id"));
        obj.setConditionSubtypeId(rs.getInt("condition_subtype_id"));
        ...
        obj.setFeeName(rs.getBigDecimal("fee_name"));
        ...
        obj.setFeeCurrency(rs.getBigDecimal("fee_currency"));
        obj.setFeeIcon(rs.getBigDecimal("fee_icon"));
